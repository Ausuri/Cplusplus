...
class BST
{
 ...
 ------------------------------------------------------------------------*/
  ...
  int heightR(BinNodePointer subtreeRoot) const;
   /*------------------------------------------------------------------------
    Description here
 ...
 ------------------------------------------------------------------------*/
  ...
  void leaves(int &count, BinNodePointer subtreeRoot); 
     /*------------------------------------------------------------------------
    Description here
...
template <typename DataType>
int BST<DataType>::height() const
{
     return heightR(myRoot);
}

//--- Definition of heightR()
template <typename DataType>
int BST<DataType>::heightR(BinNodePointer subtreeRoot) const
{
    if (subtreeRoot == NULL)
       return 0;
    int left = heightR(subtreeRoot->left);
    int right = heightR(subtreeRoot->right);
    if(left > right)
        return left + 1;
    else
        return right + 1;
...
//--- Definition of getLeaves()
template <typename DataType>
int BST<DataType>::getLeaves()
{
    int leafCount = 0;
    leaves(leafCount, myRoot);
    return leafCount;
}

//--- Definition of leaves()
template <typename DataType>
void BST<DataType>::leaves(int &count, BinNodePointer subtreeRoot)
{
    if (subtreeRoot == NULL)
       return;
    ...
    {
        leaves(count, subtreeRoot->left);
        leaves(count, subtreeRoot->right);
    }
}
